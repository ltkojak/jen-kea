# ─────────────────────────────────────────────────────────────────────────────
# LEGACY FILE — NOT EXECUTED
#
# This is the original jen.py monolith (v2.5.x and earlier).
# It is retained here for reference only.
#
# As of v2.6.0, Jen runs from run.py via the jen/ package:
#   jen/__init__.py         app factory
#   jen/extensions.py       shared state
#   jen/config.py           configuration
#   jen/models/             database and user models
#   jen/services/           kea, alerts, fingerprint, mfa, auth
#   jen/routes/             14 Flask blueprints
#
# This file is NOT imported or executed anywhere in the current codebase.
# ─────────────────────────────────────────────────────────────────────────────
